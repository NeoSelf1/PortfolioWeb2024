    ...
    >
      ...
      {isKorean ? (
        ...
        <p className="mb-3 font-light">
          ...
          computer engineering, in order to become a developer who can produce
          results directly. Thanks to that, I was able to gain CS knowledge so
          that I can immediately challenge whenever a new technology emerges.
          <br /> My core stacks are Javascript and Typescript, which are based
          on React-native, and I'm currently learning{" "}
          <span className="font-bold">Swift covering VisionOS platform</span> by
          myself because I'm fascinated by the iOS platform.
        </p>
      )}
    </motion.section>
  );
